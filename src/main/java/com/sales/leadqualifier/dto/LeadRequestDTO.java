...
/**
 * Data Transfer Object for validating and holding lead creation/update requests.
 */
public class LeadRequestDTO {
    ...
    @Min(value = 1, message = "Company size must be greater than zero")
    private Integer companySize;

    @NotNull(message = "Annual revenue is required")
    @DecimalMin(value = "0.01", message = "Annual revenue must be greater than zero")
    ...
    @Pattern(regexp = "^\\+?[0-9\\-\\s()]{7,20}$", message = "Please enter a valid phone number format")
