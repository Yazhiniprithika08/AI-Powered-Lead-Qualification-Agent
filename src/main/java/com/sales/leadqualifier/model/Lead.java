package com.sales.leadqualifier.model;
...
/**
 * Model class representing a Lead entity stored in MongoDB.
 * Holds demographic details, firmographics, and AI evaluation metrics.
 */
...
public class Lead {
    ...
    // Constructor for creating new Leads in Phase 2
    public Lead(String leadName, String companyName, String industry, String jobRole, 
                Integer companySize, Double annualRevenue, Double budget, String timeline, 
                String requirement, String email, String phoneNumber) {
    ...
    public Lead(String id, String leadName, String companyName, String industry, String jobRole, 
                Integer companySize, Double annualRevenue, Double budget, String timeline, 
